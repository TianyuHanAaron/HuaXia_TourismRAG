# Step 21: Trip Draft Review And Approval

## Goal
Redesign trip draft review so approval feels informed and decisive.

- Execution detail: turn this step into an approved UI specification for Trip Draft Review And Approval before any implementation begins.
...
## User Decision Gate
Approve before implementation: layout default shows summary, route logic, cost/pace fit, risk, and required confirmations; CTA default is Approve trip and create checklist; secondary default is Edit draft; density default is structured but not dense; copy default explains tradeoffs without model jargon; visual default uses confidence chips and phase cards.
...
## Reference Inputs
Use Marriott review clarity, BlaBlaCar trust wording, and V6 approval flow.
...
## Product Behavior
Users can review the generated trip and understand what will happen after approval.
...
## Web UI Scope
Web review may show richer citations and comparisons.
...
## Mobile UI Scope
Mobile review prioritizes summary, decisions, and CTA.
...
## Data Flow
Draft data, citations, route bundles, and risk cards feed review sections.
...
## Edge Cases
Missing route, incomplete booking context, low confidence, and conflicting preferences.
...
## Test Plan
Test approve, edit, low confidence, missing data, and long itinerary states.
...
## Acceptance Criteria
Users can approve with confidence and clear consequences.
