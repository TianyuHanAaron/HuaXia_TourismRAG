# Step 36: Safety Risk And Emergency UI

## Goal
Design safety, emergency, and local risk surfaces with calm urgency.

- Execution detail: turn this step into an approved UI specification for Safety Risk And Emergency UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: safety card default shows risk, location, action, source, and emergency contact; critical state default uses strong contrast without alarmist copy; CTA default is Call, Open location, or View guidance; collapsed detail default keeps source and audit info secondary; visual default avoids sensational imagery.
...
## Reference Inputs
Use V3 safety provider plans, Marriott clarity, and FocusFlight high-contrast execution.
...
## Product Behavior
Users can understand and act on safety guidance quickly.
...
## Web UI Scope
Web can expose support/admin safety references.
...
## Mobile UI Scope
Mobile shows safety on Home, Tasks, and Safety screen.
...
## Data Flow
Safety card, location, trip phase, emergency contacts, and provider references feed UI.
...
## Edge Cases
No local data, stale risk, critical alert, unknown phone number, and offline state.
...
## Test Plan
Test normal, warning, critical, offline, and emergency action states.
...
## Acceptance Criteria
Safety UI is direct, recoverable, and not fear-driven.
