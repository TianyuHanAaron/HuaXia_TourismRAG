# Step 45: Web Planning Shell Redesign

## Goal
Redesign the React web planning shell so it feels like the same product as mobile without copying mobile density.

- Execution detail: turn this step into an approved UI specification for Web Planning Shell Redesign before any implementation begins.
...
## User Decision Gate
Approve before implementation: web layout default uses planning workspace with left prompt/composer, center draft/review, and right context panel; visual default is light paper with dark execution previews; CTA default is action-first; density default is desktop efficient; copy default stays traveler-centered; responsive default collapses to mobile-like flow.
...
## Reference Inputs
Use Wanderlog planning structure, Marriott review clarity, and existing React web composer.
...
## Product Behavior
Web supports deeper planning, draft review, citations, and demo presentation.
...
## Web UI Scope
Web planning shell gets a complete V8 treatment.
...
## Mobile UI Scope
Mobile remains the execution reference.
...
## Data Flow
Composer input, job progress, final answer, draft, citations, and approval state feed the workspace.
...
## Edge Cases
Small laptop, long answer, failed job, partial draft, and mobile browser.
...
## Test Plan
Test desktop, tablet, mobile width, loading, error, and approval flows.
...
## Acceptance Criteria
Web planning is polished, useful, and visually aligned with mobile.
...
## Dependencies
Depends on Steps 17 through 22.
