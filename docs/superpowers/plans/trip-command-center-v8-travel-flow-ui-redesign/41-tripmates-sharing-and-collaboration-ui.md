# Step 41: Tripmates Sharing And Collaboration UI

## Goal
Design trip sharing, invite, tripmate, and collaboration states.

- Execution detail: turn this step into an approved UI specification for Tripmates Sharing And Collaboration UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: invite sheet default offers copy link, message, and email; permission default separates can edit and view only; tripmate chip default shows avatar or initials; conflict copy default explains editing overlap; visual default borrows Wanderlog collaboration but uses cleaner spacing; privacy default explains what invitees can see.
...
## Reference Inputs
Use Wanderlog tripmates, BlaBlaCar trust copy, and current account settings.
...
## Product Behavior
Users can share trips without exposing more than intended.
...
## Web UI Scope
Web supports invite management and review access.
...
## Mobile UI Scope
Mobile supports invite sheet and visible shared state.
...
## Data Flow
Tripmate role, invite status, and shared trip permissions drive UI states.
...
## Edge Cases
Expired invite, duplicate invite, removed user, offline sharing, and permission downgrade.
...
## Test Plan
Test invite, role change, revoke, share sheet, and privacy copy.
...
## Acceptance Criteria
Collaboration is clear, controlled, and not noisy.
