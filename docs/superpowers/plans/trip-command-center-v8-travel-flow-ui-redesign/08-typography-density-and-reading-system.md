# Step 8: Typography Density And Reading System

## Goal
Define type hierarchy, density, and reading rhythm for travel command screens.

- Execution detail: turn this step into an approved UI specification for Typography Density And Reading System before any implementation begins.
...
## User Decision Gate
Approve before implementation: display default is bold editorial for destination and day; control text default is compact and readable; body default is direct and short; labels default are sentence case; density default is mobile command-center, not dashboard-heavy; dynamic text default supports large accessibility settings; letter spacing default is zero.
...
## Reference Inputs
Use Timepage date hierarchy, FocusFlight hero type, BlaBlaCar plain labels, and Marriott review readability.
...
## Product Behavior
Travelers can scan next action, time, place, provider, and risk quickly.
...
## Web UI Scope
Web uses wider type rhythm without oversized marketing treatment.
...
## Mobile UI Scope
Mobile prioritizes scan speed and tap clarity.
...
## Data Flow
Display-safe labels come from view models and approved copy rules.
...
## Edge Cases
Long destinations and translated copy must wrap without overlap.
...
## Test Plan
Test large text, long city names, long provider labels, and compact cards.
...
## Acceptance Criteria
No core action or status becomes unreadable at supported text sizes.
...
## Dependencies
Depends on Step 7 color tokens.
