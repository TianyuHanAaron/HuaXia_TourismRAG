# Step 17: Trip Intake Opening Flow

## Goal
Redesign trip intake as calm travel expression rather than a long form.

- Execution detail: turn this step into an approved UI specification for Trip Intake Opening Flow before any implementation begins.
...
## User Decision Gate
Approve before implementation: opening question default is "What should this trip feel like?"; layout default is destination-first with optional natural-language prompt; CTA default is Build my trip draft; density default is spacious; imagery default is destination-search led; copy default invites preferences without operational pressure.
...
## Reference Inputs
Use Wanderlog plan-new-trip structure and current trip intake screens.
...
## Product Behavior
Users start planning with destination, vibe, dates, travelers, and constraints.
...
## Web UI Scope
Web intake becomes the richer planning surface.
...
## Mobile UI Scope
Mobile intake stays short and sectioned.
...
## Data Flow
Form fields shape the existing trip planning request.
...
## Edge Cases
Unknown destination, flexible dates, missing budget, and solo traveler cases remain valid.
...
## Test Plan
Test required fields, optional fields, keyboard, date entry, and submission.
...
## Acceptance Criteria
Trip intake feels inviting and does not overwhelm new users.
