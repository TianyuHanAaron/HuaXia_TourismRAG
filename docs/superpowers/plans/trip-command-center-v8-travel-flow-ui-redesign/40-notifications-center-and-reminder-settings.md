# Step 40: Notifications Center And Reminder Settings

## Goal
Design notifications, reminder preferences, and in-app reminder fallback.

- Execution detail: turn this step into an approved UI specification for Notifications Center And Reminder Settings before any implementation begins.
...
## User Decision Gate
Approve before implementation: notification center default groups travel alerts, tasks, provider follow-ups, document reminders, and safety; permission copy default appears before native prompt; settings default use toggles and time pickers; disabled push default still shows in-app reminders; visual default is calm and list-based.
...
## Reference Inputs
Use V4 notification requirements, Marriott settings clarity, and BlaBlaCar permission copy.
...
## Product Behavior
Users control reminder timing and understand notification purpose.
...
## Web UI Scope
Web settings can mirror reminder preferences.
...
## Mobile UI Scope
Mobile owns native notification permission and reminder education.
...
## Data Flow
Reminder settings, permission state, task urgency, and trip phase drive notification UI.
...
## Edge Cases
Permission denied, timezone change, quiet hours, duplicate reminder, and disabled push.
...
## Test Plan
Test permission education, settings save, disabled push, in-app reminder, and timezone.
...
## Acceptance Criteria
Notifications feel helpful, not spammy.
