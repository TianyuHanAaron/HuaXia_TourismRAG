# Step 42: Budget Expense And Cost Awareness UI

## Goal
Design cost awareness without turning HuaXia into a finance dashboard.

- Execution detail: turn this step into an approved UI specification for Budget Expense And Cost Awareness UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: budget summary default shows planned range, known costs, and upcoming payment tasks; expense detail default uses Marriott clarity and Wanderlog utility; CTA default is Add expense or Review cost; color default avoids red unless over budget; density default keeps cost secondary to travel actions.
...
## Reference Inputs
Use Wanderlog budget surfaces and Marriott transaction clarity.
...
## Product Behavior
Users understand cost implications when they affect decisions.
...
## Web UI Scope
Web may show fuller budget review and export.
...
## Mobile UI Scope
Mobile shows cost cues on Home, Review, Tasks, and Settings.
...
## Data Flow
Budget, known expenses, booking tasks, and provider search context feed cost UI.
...
## Edge Cases
Unknown cost, currency change, split expense, over budget, and missing exchange data.
...
## Test Plan
Test budget summary, expense row, unknown cost, over budget, and currency display.
...
## Acceptance Criteria
Cost UI is useful and does not dominate trip execution.
