# Step 16: Permissions Privacy And Consent

## Goal
Design permission prompts and privacy copy that build trust.

- Execution detail: turn this step into an approved UI specification for Permissions Privacy And Consent before any implementation begins.
...
## User Decision Gate
Approve before implementation: permission timing default is just-in-time; location prompt default appears before route preview; notification prompt default appears after trip approval or reminder setup; document privacy default states sensitive files are excluded from prompts unless approved; layout default uses bottom sheet education before native prompt.
...
## Reference Inputs
Use Marriott policy clarity, BlaBlaCar trust wording, and V6 privacy requirements.
...
## Product Behavior
Users know why permissions are requested and what remains private.
...
## Web UI Scope
Web privacy states support document and account flows.
...
## Mobile UI Scope
Mobile permission education precedes native dialogs.
...
## Data Flow
Permission status controls available UI actions and fallback copy.
...
## Edge Cases
Denied permissions keep in-app alternatives available.
...
## Test Plan
Test grant, deny, denied-then-settings, and offline permission-related states.
...
## Acceptance Criteria
No permission request appears without a clear user benefit.
