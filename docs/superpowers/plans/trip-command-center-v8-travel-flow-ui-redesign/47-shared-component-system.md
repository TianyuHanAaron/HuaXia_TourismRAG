# Step 47: Shared Component System

## Goal
Define reusable V8 component families for mobile and web.

- Execution detail: turn this step into an approved UI specification for Shared Component System before any implementation begins.
...
## User Decision Gate
Approve before implementation: component families default include AppShell, CommandCard, TimelineRail, TaskCard, ProviderSheet, RoutePreview, DocumentRow, RiskCard, StatusChip, EmptyState, Toast, BottomSheet, FormSection, and SettingsRow; radius default is modest; shadow default is restrained; component states default include default, pressed, selected, disabled, loading, error, and offline.
...
## Reference Inputs
Use V6 shared design system, existing mobile Tamagui/Paper wrappers, and web HuaXia components.
...
## Product Behavior
Repeated UI behaves consistently across screens.
...
## Web UI Scope
Web components align with mobile tokens and desktop density.
...
## Mobile UI Scope
Mobile components remain the canonical interaction model.
...
## Data Flow
View models provide display-safe labels and statuses to components.
...
## Edge Cases
Long copy, missing icons, disabled actions, dark execution surface, and large text.
...
## Test Plan
Test component states, accessibility labels, theme variants, and visual regressions.
...
## Acceptance Criteria
No major screen relies on one-off visual primitives.
