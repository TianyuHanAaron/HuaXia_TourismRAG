# Step 33: Weather Risk And Packing UI

## Goal
Design weather, route risk, outdoor warnings, and packing task surfaces.

- Execution detail: turn this step into an approved UI specification for Weather Risk And Packing UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: weather card default shows day, condition, temperature, rain, heat, and travel impact; packing task default says what to add or avoid; risk color default uses amber unless safety-critical; copy default is practical; layout default shows one top risk on Home and detail in Timeline or Tasks.
...
## Reference Inputs
Use V3 weather task requirements, Timepage day context, and BlaBlaCar plain wording.
...
## Product Behavior
Weather becomes operational guidance, not decorative forecast.
...
## Web UI Scope
Web review can show forecast source and confidence.
...
## Mobile UI Scope
Mobile surfaces weather only when it affects travel choices.
...
## Data Flow
Weather snapshots, tasks, route bundles, and activity types feed risk cards.
...
## Edge Cases
Missing forecast, stale forecast, severe weather, heat, rain, and outdoor activity conflict.
...
## Test Plan
Test normal, rain, heat, severe, stale, and unavailable states.
...
## Acceptance Criteria
Weather UI produces clear traveler actions.
