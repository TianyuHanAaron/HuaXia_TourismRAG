# Step 15: Account Setup And Profile

## Goal
Define account setup and profile screens that support travel personalization without feeling heavy.

- Execution detail: turn this step into an approved UI specification for Account Setup And Profile before any implementation begins.
...
## User Decision Gate
Approve before implementation: profile setup default asks name, home region, language, notification preference, and travel style; layout default is short sections; save CTA default is sticky; avatar default is optional; copy default says why each field helps; density default avoids long forms; screen states default include incomplete, saved, and error.
...
## Reference Inputs
Use Marriott profile clarity, BlaBlaCar preference choices, and V4 form rules.
...
## Product Behavior
Users can provide useful preferences while staying in control.
...
## Web UI Scope
Web profile uses the same fields with desktop spacing.
...
## Mobile UI Scope
Mobile profile uses native controls where useful.
...
## Data Flow
User preferences feed trip intake defaults and UI copy.
...
## Edge Cases
Optional fields do not block saving.
...
## Test Plan
Test empty profile, partial profile, save, validation, and language switch.
...
## Acceptance Criteria
Profile setup is concise, useful, and respectful.
