# Step 4: Visual Concept Review And Approval

## Goal
Define how generated concepts are reviewed, revised, accepted, and locked as the production design source.

- Execution detail: turn this step into an approved UI specification for Visual Concept Review And Approval before any implementation begins.
...
## User Decision Gate
Approve before implementation: review default is side-by-side against references; approval default locks color, type, layout, container model, copy, icon style, imagery, and motion notes; revision default allows targeted changes per screen; rejection default requires a new concept pass; handoff default stores approved concept paths and decisions.
...
## Reference Inputs
Use generated concepts from Step 3 and the reference audit from Step 2.
...
## Product Behavior
Approved concepts become the source of truth for the redesign.
...
## Web UI Scope
Web concepts must be approved separately from mobile concepts.
...
## Mobile UI Scope
Mobile concepts must cover normal, urgent, offline, blocked, and success states.
...
## Data Flow
Approval records map concept choices into implementation specs.
...
## Edge Cases
If web and mobile concepts conflict, mobile wins unless the user approves otherwise.
...
## Test Plan
Verify every approved concept has a matching decision record.
...
## Acceptance Criteria
No visual implementation begins from unapproved concept material.
