# Step 26: Day Detail And Itinerary Items

## Goal
Design the day detail view and itinerary item anatomy.

- Execution detail: turn this step into an approved UI specification for Day Detail And Itinerary Items before any implementation begins.
...
## User Decision Gate
Approve before implementation: day header default shows date, city, weather, and phase; item default shows time, place, short context, route readiness, documents, and actions; layout default uses stacked list, not card grid; density default supports quick scanning; copy default uses plain travel language; component default supports reorder, skip, edit, and open provider.
...
## Reference Inputs
Use Timepage event cards, Wanderlog itinerary items, and BlaBlaCar action rows.
...
## Product Behavior
Users can inspect a day without losing the larger trip context.
...
## Web UI Scope
Web day detail can include citations and planning notes.
...
## Mobile UI Scope
Mobile day detail supports execution and light editing.
...
## Data Flow
Day, items, tasks, provider actions, weather, and documents feed the list.
...
## Edge Cases
All-day items, missing times, duplicate places, skipped item, and weather warning.
...
## Test Plan
Test item states, edit, skip, reorder, provider action, and large text.
...
## Acceptance Criteria
Day detail is readable, flexible, and action-ready.
