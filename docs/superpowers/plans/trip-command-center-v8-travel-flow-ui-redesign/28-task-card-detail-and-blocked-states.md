# Step 28: Task Card Detail And Blocked States

## Goal
Define detailed task anatomy, edit surfaces, and blocked explanations.

- Execution detail: turn this step into an approved UI specification for Task Card Detail And Blocked States before any implementation begins.
...
## User Decision Gate
Approve before implementation: detail layout default shows task, reason, due time, phase, unlocks, documents, provider action, and audit note collapsed; blocked copy default is one sentence; edit default is bottom sheet; defer default offers later today, tomorrow, and custom; completion default has optimistic feedback and undo.
...
## Reference Inputs
Use BlaBlaCar clear choices, Marriott review rows, and current task detail screens.
...
## Product Behavior
Users understand why a task exists and how to resolve it.
...
## Web UI Scope
Web detail supports admin and planning review.
...
## Mobile UI Scope
Mobile detail prioritizes action, dependency, and recovery.
...
## Data Flow
Task detail, dependency, provider action, document, and sync state feed the view.
...
## Edge Cases
Missing dependency, completed dependency, invalid action, offline edit, and conflict.
...
## Test Plan
Test blocked, edit, defer, complete, undo, and conflict states.
...
## Acceptance Criteria
Blocked tasks are understandable and solvable.
