# Step 6: Travel Flow Mood System

## Goal
Define phase-aware UI moods for idea, review, preparation, departure, transit, arrival, exploration, return, and home completion.

- Execution detail: turn this step into an approved UI specification for Travel Flow Mood System before any implementation begins.
...
## User Decision Gate
Approve before implementation: mood default uses calm planning, decisive review, organized preparation, high-contrast departure, focused transit, soft arrival, flexible exploration, and conclusive return; color intensity default rises with urgency; copy default changes by phase; motion default gets quieter during stressful moments.
...
## Reference Inputs
Use FocusFlight for execution mood, Timepage for time rhythm, and V6 travel flow awareness.
...
## Product Behavior
The UI adapts to traveler urgency and emotional load.
...
## Backend Scope
No backend changes; phase data remains existing workflow data.
...
## Web UI Scope
Web shows mood as review context, not immersive execution mode.
...
## Mobile UI Scope
Mobile applies mood to headers, action cards, alerts, and provider surfaces.
...
## Data Flow
Trip phase maps into `TravelFlowMoodTheme`.
...
## Edge Cases
If phase is unknown, default to preparation mood with neutral urgency.
...
## Test Plan
Verify every phase has copy, color, state, and CTA guidance.
...
## Acceptance Criteria
Mood changes clarify action without causing panic.
