# Step 13: Onboarding Guided Tour

## Goal
Create a short guided tour that teaches the product through traveler outcomes.

- Execution detail: turn this step into an approved UI specification for Onboarding Guided Tour before any implementation begins.
...
## User Decision Gate
Approve before implementation: tour length default is three screens; topics default are Plan calmly, Travel confidently, Keep proof ready; layout default is large image plus one sentence; CTA default is Continue; skip default is visible; copy tone default is friendly and practical; motion default is horizontal slide with reduced-motion fallback.
...
## Reference Inputs
Use FocusFlight onboarding scale and BlaBlaCar plain guidance.
...
## Product Behavior
Users learn value through action, not feature explanation.
...
## Web UI Scope
Web may reuse tour copy for demo onboarding.
...
## Mobile UI Scope
Mobile tour appears only for users who have not completed onboarding.
...
## Data Flow
Local onboarding completion state controls visibility.
...
## Edge Cases
Users can skip without losing access to trip intake.
...
## Test Plan
Test continue, skip, completion persistence, and large text.
...
## Acceptance Criteria
Tour is short, readable, and never blocks trip creation.
