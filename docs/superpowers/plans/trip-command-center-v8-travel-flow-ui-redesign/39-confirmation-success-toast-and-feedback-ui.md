# Step 39: Confirmation Success Toast And Feedback UI

## Goal
Design confirmations, success states, toast messages, and feedback capture.

- Execution detail: turn this step into an approved UI specification for Confirmation Success Toast And Feedback UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: confirmation default asks only for destructive or provider-launch decisions; success default states what changed; toast default includes action-specific wording and optional undo; feedback default is short bottom sheet; copy default avoids technical queue terms; motion default is subtle and skippable.
...
## Reference Inputs
Use BlaBlaCar completion feedback, Marriott confirmations, and V6 microinteractions.
...
## Product Behavior
Users receive clear feedback after every meaningful action.
...
## Web UI Scope
Web uses toast and confirmation patterns for planning/admin actions.
...
## Mobile UI Scope
Mobile uses toasts, sheets, and optimistic completion feedback.
...
## Data Flow
Action result, undo availability, sync status, and analytics event select feedback.
...
## Edge Cases
Undo expired, offline queued, provider launch uncertain, destructive action, and retry.
...
## Test Plan
Test completion, undo, delete confirmation, provider follow-up, and feedback send.
...
## Acceptance Criteria
Feedback is immediate, human, and reversible where possible.
