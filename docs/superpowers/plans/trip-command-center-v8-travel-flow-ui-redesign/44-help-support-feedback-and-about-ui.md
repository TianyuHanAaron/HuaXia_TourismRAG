# Step 44: Help Support Feedback And About UI

## Goal
Design support, feedback, about, policy, and troubleshooting surfaces.

- Execution detail: turn this step into an approved UI specification for Help Support Feedback And About UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: help layout default is search plus common travel issues; support actions default include report issue, provider problem, document problem, and contact support; feedback default is lightweight; about default is concise; copy default says what logs or data may be included; visual default is calm paper surface.
...
## Reference Inputs
Use Marriott account trust, BlaBlaCar simple wording, and V7 debugging artifacts.
...
## Product Behavior
Users can recover when the app or provider handoff fails.
...
## Web UI Scope
Web can include admin diagnostics links.
...
## Mobile UI Scope
Mobile support is accessible from Settings and error states.
...
## Data Flow
App version, trip id, provider action id, and error state can prefill support context.
...
## Edge Cases
Offline support draft, sensitive data, provider failure, and auth expiry.
...
## Test Plan
Test help search, report issue, feedback, privacy copy, and offline draft.
...
## Acceptance Criteria
Support UI is useful without exposing sensitive data by default.
