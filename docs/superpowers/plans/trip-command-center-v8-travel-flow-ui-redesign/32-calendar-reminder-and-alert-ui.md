# Step 32: Calendar Reminder And Alert UI

## Goal
Redesign calendar export, reminders, and alert presentation.

- Execution detail: turn this step into an approved UI specification for Calendar Reminder And Alert UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: calendar preview default shows event title, time, location, notes, and calendar target; reminder setup default explains value before permission; alert style default uses concise banner or card; CTA default is Add to calendar; copy default avoids technical event terms; screen states default include preview, permission needed, saved, and failed.
...
## Reference Inputs
Use Marriott confirmation clarity, BlaBlaCar permission copy, and V4 notification requirements.
...
## Product Behavior
Users can preview and control reminders before exporting.
...
## Web UI Scope
Web supports download or cloud sync preview where available.
...
## Mobile UI Scope
Mobile owns Expo Calendar and reminder permission flows.
...
## Data Flow
Task, itinerary, phase, and reminder settings map into calendar event previews.
...
## Edge Cases
Denied permission, timezone change, duplicate event, missing location, and offline state.
...
## Test Plan
Test preview, permission, save, duplicate, failure, and disabled push.
...
## Acceptance Criteria
Calendar actions are previewed and reversible.
