# Step 43: Settings Preferences Account And Deletion UI

## Goal
Redesign settings, preferences, account controls, and account deletion flows.

- Execution detail: turn this step into an approved UI specification for Settings Preferences Account And Deletion UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: settings layout default is grouped list; preference controls default use switches, chips, segmented controls, and native pickers; destructive actions default use confirmation sheet; deletion copy default explains data effects plainly; visual default follows Marriott clarity with V8 tokens; density default is compact and readable.
...
## Reference Inputs
Use Marriott settings clarity, BlaBlaCar preference rows, and V4 stack ownership rules.
...
## Product Behavior
Users can manage preferences and account risk confidently.
...
## Web UI Scope
Web settings align with mobile groups.
...
## Mobile UI Scope
Mobile settings supports profile, language, privacy, reminders, documents, and account actions.
...
## Data Flow
User preferences, auth state, and subscription status feed settings groups.
...
## Edge Cases
Offline save, failed deletion, signed-out state, expired session, and language switch.
...
## Test Plan
Test preference save, destructive confirmation, deletion, sign out, and large text.
...
## Acceptance Criteria
Settings are clear, safe, and easy to scan.
