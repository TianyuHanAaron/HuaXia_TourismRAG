# Step 34: Document Vault Groups

## Goal
Redesign the document vault around travel proof and booking retrieval.

- Execution detail: turn this step into an approved UI specification for Document Vault Groups before any implementation begins.
...
## User Decision Gate
Approve before implementation: groups default to flight/train, lodging, tickets, ID/passport, insurance, and custom; layout default is compact grouped list; privacy marker default appears on sensitive documents; search default is visible; empty state default invites import by category; visual default uses Marriott clarity with subtle travel icons.
...
## Reference Inputs
Use Marriott document/account clarity and V4 document vault requirements.
...
## Product Behavior
Documents answer "what proof or booking do I need?"
...
## Web UI Scope
Web document review can include admin metadata.
...
## Mobile UI Scope
Mobile vault prioritizes fast retrieval and task attachment.
...
## Data Flow
Document metadata, category, sensitivity, task link, and trip phase feed groups.
...
## Edge Cases
No documents, expired document, sensitive document, duplicate file, and offline cached document.
...
## Test Plan
Test grouping, search, sensitive marker, empty state, and offline access.
...
## Acceptance Criteria
Documents are easy to find under travel pressure.
