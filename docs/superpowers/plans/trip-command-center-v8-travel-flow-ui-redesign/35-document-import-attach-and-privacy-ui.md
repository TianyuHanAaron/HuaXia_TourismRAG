# Step 35: Document Import Attach And Privacy UI

## Goal
Design document import, parse result, attach-to-task, and privacy controls.

- Execution detail: turn this step into an approved UI specification for Document Import Attach And Privacy UI before any implementation begins.
...
## User Decision Gate
Approve before implementation: import default uses one bottom sheet; parse result default shows detected type, trip match, extracted dates, and confidence; attach default selects task in the same sheet; privacy default excludes sensitive documents from prompts unless user approves; error copy default says what was kept safe.
...
## Reference Inputs
Use V3 document import policy, V4 document UI, and Marriott trust surfaces.
...
## Product Behavior
Users can import documents safely and attach them to relevant tasks.
...
## Web UI Scope
Web can show parse metadata in review/admin views.
...
## Mobile UI Scope
Mobile owns import, attach, and privacy confirmation.
...
## Data Flow
Document parser metadata, task candidates, and privacy flags feed the sheet.
...
## Edge Cases
Unreadable file, sensitive file, wrong trip match, duplicate, and offline import.
...
## Test Plan
Test import, parse result, attach, privacy toggle, failure, and recovery.
...
## Acceptance Criteria
Sensitive documents are protected by default.
